...
DECLARE @Historic_StartTime DATETIME = '2024-08-29 00:00:00'; -- Start time
DECLARE @Historic_EndTime DATETIME = '2024-09-01 00:00:00';   -- End time
DECLARE @Historic_TrackCode	VARCHAR(MAX) = 'QRD'
DECLARE @Historic_Track_Section	VARCHAR(MAX) = '65590-65835'
DECLARE @Historic_TimeStep INT = 12; -- Time step in minutes (e.g., 60 for 1 hour intervals)
