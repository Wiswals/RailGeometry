...
--===============================================================================================================================
--Debug Settings
	DECLARE @Debug as int = 1								-- If set to	0 = live automation from exe (Restrain results, allow dynamic variable setting), 
															--				1 = Psuedo live (Print Results, keep data), 
															--				2 = debug mode (Print results, clear and reset tables)
...
--Calculation Settings
	...
	DECLARE @DataExtractionWindow as int = 6000				-- Number of hours to look back when extracting data for the calculations
					...
					BEGIN
						...
						IF @Debug = 2
							BEGIN
								...
								EXEC (@Database_Script)
								PRINT '   ' + CONVERT(VARCHAR, GETDATE(), 103) + ' ' + CONVERT(VARCHAR, GETDATE(), 14) + ' | WARNING - Script running in debug mode. [GeometryData] and [PrismData] tables have been cleared and reset.';
							END

						-- Assume end of script reached - drop temp tables
