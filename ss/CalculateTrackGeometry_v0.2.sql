...
-- Declare variables for error handling and control flow
	...
	DECLARE @OverdueTotalCount INT = 0;
...
--Track geometry variables
	...
	DECLARE @CalculationComment varchar(max), @OverdueCount int
...
--=============================================================================================================================== 
	BEGIN TRY
		...
		PRINT CONVERT(VARCHAR, GETDATE(), 103) + ' ' + CONVERT(VARCHAR, GETDATE(), 14) + ' | Successfully retrieved track information.';
	...
	BEGIN
		...
		IF @Debug = 2
			BEGIN
				...
				SET @Database_Script =	'USE [Automated Track Geometry] DELETE FROM GeometryHistory DELETE FROM PrismHistory DELETE FROM ReportingData'
				EXEC (@Database_Script)
			END
	END
...
END TRY
BEGIN CATCH
    -- Error Handling: Print the error message and exit
