...
--Calculation Settings
	...
	DECLARE @DataExtractionWindow as int = 2500				-- Number of hours to look back when extracting data for the calculations
			...
			BEGIN
				...
				IF @Calculation_Check = 1
					BEGIN
						...
						BEGIN TRY
							SET @Database_Script =	'USE [Automated Track Geometry]
													INSERT INTO GeometryHistory SELECT	[Calculation_ID], [Track_Code], [Track_Code] + ''-'' + FORMAT(Track_CL_Chainage,'''+ @ChainageNameFormat +''') as [Geometry_Instrument],
