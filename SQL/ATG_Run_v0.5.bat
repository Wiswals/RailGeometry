...
SET Config_File=%Directory%ATG_Configure_v0.5.ini
SET SQL_File=%Directory%CalculateLiveTrackGeometry_v0.5.sql
...
sqlcmd -S "%ServerName%" -E -d "%DatabaseName%" -i "%SQL_File%" -v CalculationFrequency="%CalculationFrequency%" DataExtractionWindow="%DataExtractionWindow%" PrismSpacingLimit="%PrismSpacingLimit%" ChainageStep="%ChainageStep%" ShortTwistStep="%ShortTwistStep%" LongTwistStep="%LongTwistStep%" ShortLineChord="%ShortLineChord%" LongLineChord="%LongLineChord%" ShortTopChord="%ShortTopChord%" LongTopChord="%LongTopChord%" LeftRailIndicator="%LeftRailIndicator%" RightRailIndicator="%RightRailIndicator%" ChainageNameFormat="%ChainageNameFormat%" -h -1 >>%Log_File%
@echo.>>%Log_File%
