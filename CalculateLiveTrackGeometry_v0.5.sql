...
--===============================================================================================================================
--Debug Settings
	DECLARE @Debug as int = 0								-- If set to	0 = live automation from exe (Restrain results, allow dynamic variable setting), 
...
--Calculation Settings
	...
	DECLARE @DataExtractionWindow as int = 9000				-- Number of hours to look back when extracting data for the calculations
