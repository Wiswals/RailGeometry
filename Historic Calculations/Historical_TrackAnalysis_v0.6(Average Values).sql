...
DECLARE @ChainageStep decimal(30,10) = 1				-- The spacing at which you want to calculate track geometry at. i.e. every x meters.
DECLARE @ShortTwistStep decimal(30,10) = 3			-- The spacing at which short twist should be calculated, looking in reverse chainage.
DECLARE @LongTwistStep decimal(30,10) = 10			-- The spacing at which long twist should be calculated, looking in reverse chainage.

DECLARE @ShortLineChord decimal(30,10) = 10			-- The chord length for the short line calculation, looking foward and back half of this length from reference chainage.
DECLARE @LongLineChord decimal(30,10) = 20				-- The chord length for the long line calculation, looking foward and back half of this length from reference chainage.
DECLARE @ShortTopChord decimal(30,10) = 10				-- The chord length for the short top calculation, looking foward and back half of this length from reference chainage.
DECLARE @LongTopChord decimal(30,10) = 20				-- The chord length for the long top calculation, looking foward and back half of this length from reference chainage.
...
SELECT	@StartTimeHistory = '01/10/2021 00:00',		-- 
		@EndTimeHistory = '01/10/2021 06:00',		-- 
